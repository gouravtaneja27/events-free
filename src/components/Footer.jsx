            ...
            <div className="container">
                <div className="row row-gap-5">
                    <div className="col-lg-6 col-12">
                        <img src="/assets/images/footer-logo.svg" alt="logo" className="w-100 max-w-316" />
                        ...
                        <div className="d-flex justify-content-between width-100">
                            <img src="/assets/images/insta.svg" alt="instagram" className="social-media" />
                            <img src="/assets/images/facebook.svg" alt="facebook" className="social-media" />
                            <img src="/assets/images/twitter.svg" alt="twitter" className="social-media" />
                        </div>
                    </div>
                        ...
                        <div className="row row-gap-5">
                            ...
                            <div className="col-lg-6 col-12">
                                ...
                                <div className="grid-parent">
                                    <div className="div11"> <img src="/assets/images/g1.png" alt="" className="w-100" />
                                    </div>
                                    <div className="div12"><img src="/assets/images/g2.png" alt="" className="w-100" />
                                    </div>
                                    <div className="div31"><img src="/assets/images/g3.png" alt="" className="w-100" />
                                    </div>
                                    <div className="div14"><img src="/assets/images/g4.png" alt="" className="w-100" />
                                    </div>
                                    <div className="div15"><img src="/assets/images/g5.png" alt="" className="w-100" />
                                    </div>

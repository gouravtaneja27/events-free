...
export default function Events() {
    return (
        <>
            ...
            <section className="events-banner  text-white  ">
                ...
                <div className="container  py-5">
                    ...
                    <div className="row">
                        <div className="col-12 py-5">
                            <p className="breadcrumb-text mb-1">Home &gt; Events</p>
            ...
            <section className="events-content py-5">
                <div className="container">
                    ...
                    <div className="row g-4">
                        {events.map((ev) => (
                            <div key={ev.id} className="col-sm-6 col-md-4">
                                <div className="card event-card h-100 shadow-sm rounded-5 border-1 padding-left hover padding-right">
                                    <div className="card-img-top overflow-hidden rounded-top-3">
                                        <img src={ev.image} alt={ev.title} className="w-100" />
                                    </div>

                                    <div className="card-body d-flex flex-column">
                                        <h5 className="card-title fw-md">{ev.title}</h5>

                                        <ul className="event-meta list-unstyled mt-3 mb-3">
                                            <li className="d-flex align-items-center gap-2">
                                                <span className="meta-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g opacity="0.6">
                                            ...
                                            <li className="d-flex align-items-center gap-2">
                                                <span className="meta-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clipPath="url(#clip0_107448_404)">
                                                        <path d="M19.1998 8.15996C19.1998 14.6899 11.9998 23.04 11.9998 23.04C11.9998 23.04 4.7998 14.8454 4.7998 8.15996C4.7998 4.18316 8.023 0.959961 11.9998 0.959961C15.9761 0.959961 19.1998 4.18316 19.1998 8.15996Z" stroke="#666666" stroke-width="1.7647" stroke-miterlimit="10" stroke-linejoin="round" />
                                                        <path d="M12.0001 11.52C13.5907 11.52 14.8801 10.2306 14.8801 8.64001C14.8801 7.04943 13.5907 5.76001 12.0001 5.76001C10.4095 5.76001 9.12012 7.04943 9.12012 8.64001C9.12012 10.2306 10.4095 11.52 12.0001 11.52Z" stroke="#666666" stroke-width="1.7647" stroke-miterlimit="10" stroke-linejoin="round" />
                                                    </g>
                                                    <defs>
                                                        <clipPath id="clip0_107448_404">
                                            ...
                                            <li className="d-flex align-items-center gap-2">
                                                <span className="meta-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <g clipPath="url(#clip0_107448_541)">
                                                    ...
                                                    <defs>
                                                        <clipPath id="clip0_107448_541">
                                                            <rect width="24" height="24" fill="white" />
                                                        </clipPath>
                                                    </defs>
                                                </svg>
                                                </span>
                                                <small className="text-muted">{ev.capacity}</small>
                                            </li>
                                        </ul>

                                        <div className="mt-auto">
                                            <button className="btn btn-primary btn-go rounded-pill px-4">
                                                Go Check
                                            </button>
                                        </div>
                                    </div>
